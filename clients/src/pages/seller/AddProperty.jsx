...
const AddProperty = () => {
    ...
    const handleImageChange = (e) => {
        ...
        if (images.length + files.length > 10) {
            toast.error("You can only upload upto 10 images.");
            return;
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${API_URL}/property`, data, {
                headers: {
            ...
            toast.error("Failed to ad property", error);
            setLoading(false);
        }
    }
    return (
            ...
            <div className={s.innerContainer}>
                <div className={s.header}>
                    ...
                    <p className={s.subheading}>
                        Fill in the details below to reach thousands of pontential buyers.
                    </p>
                </div>
