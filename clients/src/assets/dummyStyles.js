...
export const editPropertyStyles = {
  ...
  // twoColumnGrid: "grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 mb-12",
  twoColumnGrid: "grid grid-cols-1  gap-8 mb-12",
...
export const profileStyles = {
  ...
  saveButton: "btn btn-color flex-1 flex items-center justify-center gap-2",
...
export const landingPageStyles = {
  ...
  categoryTitle: "text-[2.5rem] font-extrabold mb-4 max-sm:text-[1.5rem]",
...
export const propertyDetailsStyles = {
  ...
  mainContainer: "px-6 max-w-[1400px] mx-auto  fade-in pt-4",
  ...
  statValue: "font-extrabold text-[0.6rem] text-text-main capitalize break-words whitespace-normal leading-snug",
...
export const navbarStyles = {
  ...
  container: "md:container px-6 mx-auto",
