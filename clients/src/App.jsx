...
const ScrollTopButton = () => {
  ...
  return (
    <button onClick={handleClick} className={`fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full
    shadow-lg transiton-all duration-300 ${visible ? "scale-100 opacity-100 bg-emerald-500 text-white hover:bg-green-400" : "pointer-events-none scale-0 opacity-0"}`}>
      <FaChevronUp size={22} />
    </button>
  )
}

// smart layout wrapper for seler and buyer
...
const App = () => {
  ...
  }, []); // prevent horizona overflow on the whole app
    ...
    <div className='min-h-screen w-full overflow-hidden'>
      ...
      <Routes>
        ...
        <Route element={<PublicRoute />}>
          ...
          {/* Verify email — no redirect needed */}
